...
import com.kuding.microservice.task.ServiceExistCheckTask;
...
public class ServiceExistControl implements SmartInitializingSingleton, DisposableBean {
	...
	public void afterSingletonsInstantiated() {
		Set<String> allService = serviceMonitorProperties.getMonitorServices().keySet();
		ServiceExistCheckTask serviceExistCheckTask = new ServiceExistCheckTask(allService, discoveryClient,
